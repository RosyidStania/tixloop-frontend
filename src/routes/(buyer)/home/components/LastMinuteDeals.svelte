<div class="pl-4">
  ...
  <p class="text-gray-400 text-xs mb-4 pr-4">Grab these hot deals before they're gone!</p>
  ...
  <div class="flex overflow-x-auto hide-scrollbar gap-4 pb-4 pr-4">
    <div class="min-w-[240px] bg-[#14121E] rounded-2xl overflow-hidden border border-[#232033]">
      <div class="h-32 bg-gray-800 relative bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1540039155733-d7696d54af58?q=80&w=600&auto=format&fit=crop');">
      ...
      <div class="p-4">
        <h3 class="font-bold mb-1">Cold Play 2026</h3>
        <p class="text-xs text-gray-400 mb-3">Various Artists</p>
        ...
        <div class="flex justify-between items-end mb-4">
          <div>
            <p class="text-[10px] text-gray-500 line-through">Rp 600.000</p>
            <p class="text-[#D4FF00] font-bold text-sm">Rp 450.000</p>
          </div>
          <div class="bg-[#FF3366] text-white text-[10px] font-bold px-2 py-0.5 rounded">-25%</div>
        </div>

        <button class="w-full bg-gradient-to-r from-[#FF3366] to-[#8C1B3F] text-white text-xs font-bold py-2.5 rounded-xl">Burn Mode</button>
      </div>
    </div>
