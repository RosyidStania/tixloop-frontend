...
<main class="bg-[#0A0910] min-h-screen text-white font-sans flex flex-col pt-16 px-5 pb-8">
  <div class="flex flex-col items-center text-center mb-8">
    ...
    <p class="text-xs text-gray-400 leading-relaxed">
      Tiket kamu sedang diproses.<br/>Kamu akan menerima konfirmasi via email.
    </p>
  </div>
  ...
  <div class="bg-[#14121E] rounded-3xl relative overflow-hidden flex-1 border border-[#232033] flex flex-col max-h-[400px]">
    <div class="p-6">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          <h3 class="font-bold text-sm">Jazz Festival 2026</h3>
          <p class="text-[10px] text-gray-400">General Admission</p>
        </div>
      </div>
      <div class="space-y-2">
    ...
    <div class="p-6 flex flex-col items-center justify-center flex-1">
      ...
      <p class="text-[#D4FF00] font-mono font-bold text-sm tracking-wider mb-6">{orderId}</p>
      ...
      <div class="w-full bg-[#1A1825] p-4 rounded-xl flex justify-between items-center">
        ...
        <span class="text-[#D4FF00] font-bold text-sm">Rp {total.toLocaleString('id-ID')}</span>
      </div>
    </div>
  </div>
  ...
  <div class="space-y-3 mt-auto pb-safe">
    <a href="#" class="w-full bg-[#D4FF00] text-black font-bold py-3.5 rounded-xl flex justify-center items-center gap-2">
