  ...
  <div class="flex-1 px-4 pt-8 pb-10 space-y-5">
    ...
    <div class="space-y-3">
      <div>
        ...
        <input id="email" bind:value={email} type="email" placeholder="contoh@email.com" class="w-full bg-[#14121E] border border-[#232033] rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 outline-none focus:border-[#AAEF45]/60 transition-colors" />
      </div>
      ...
      <div>
        ...
        <div class="relative">
          <input id="password" bind:value={password} type={showPassword ? 'text' : 'password'} placeholder="Masukkan password" class="w-full bg-[#14121E] border border-[#232033] rounded-xl px-4 py-3 pr-11 text-sm text-white placeholder-gray-600 outline-none focus:border-[#AAEF45]/60 transition-colors" />
